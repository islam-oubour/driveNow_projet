    ...
    <div class="page">
        ...
        <div class="mid">
            <div class="content" style="margin-top: 60px">
                ...
                né(e) le : <strong><?php echo e(date('d/m/Y', strtotime($item->date_naissance_etud))); ?></strong> à
                <strong><?php echo e($item->ville_naissance_etud); ?></strong> <br>
                ...
                Parcours : <strong><?php echo e(str_replace(' ', '-', $item->intitule)); ?></strong>
                (<strong><?php echo e($item->id_tronc); ?></strong>) <br>
                Année universitaire : <strong><?php echo e($item->au_jury_DEUST); ?></strong> <br>
                Session : <strong><?php echo e($item->session_admis_DEUST == 'P' ? 'Printemps' : 'Automne'); ?></strong> <br>
            ...
            <table style="width: 100%; margin-top: 60px">
                <tr>
                    <td style="width: 70%">Errachidia, le :
                        <strong><?php echo e(date(date('d/m/Y'), strtotime($item->dn))); ?></strong></td>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/deliberation/attestations/DEUST_single.blade.php ENDPATH**/ ?>