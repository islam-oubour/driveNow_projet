...
<body>
    <table style="width: 100%; padding: 0; margin-bottom: 25px">
        <tr>
            <td align="left"><img height="60" src="<?php echo e(public_path('images/logo.png')); ?>" alt=""></td>
        </tr>
    </table>
    <table style="width: 100%; padding: 0; margin-bottom: 25px">
        <tr>
    ...
    <main>
                ...
                <?php else: ?>
                    <?php if(isset($student['id_tronc'])): ?>
                        <tr>
                            ...
                            <td><strong>: </strong><?php echo e($tronc); ?> (<?php echo e($student['id_tronc']); ?> )</td>
                        </tr>
                    <?php endif; ?>
                <?php endif; ?>
        ...
        <div class="content">
            <?php echo $__env->make('PDF.layouts.semestre', ['data' => $S, 'semestre' => 'S' . $semestre, 'moy' =>  $moy, 'res' => $res , 'dc' => $dc], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/fste-umi/public_html/fst/docs/website/resources/views/PDF/rDivProvisoire.blade.php ENDPATH**/ ?>