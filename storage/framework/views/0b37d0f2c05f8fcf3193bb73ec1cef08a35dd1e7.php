...
<?php $__currentLoopData = $data['listeAD']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($item['demande'] == 0): ?>
        <tr>
            ...
            <td rowspan="2" align="center" class="w-xs col-bg"><?php echo e($item['Moy-S5']); ?></td>
            <td rowspan="2" align="center" class="w-xs col-bg"><small>V : <?php echo e($item['V-S5']); ?> <br>R :
                    <?php echo e($item['R-S5']); ?> <br>N : <?php echo e($item['N-S5']); ?></small></td>
            <td rowspan="2" align="center" class="w-xs col-bg"><?php echo e($item['Res-S5']); ?></td>
            ...
            <?php $__currentLoopData = $data['modules']['S6']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <td rowspan="2" align="center" class="w-xs col-bg"><?php echo e($item['Moy-S6']); ?></td>
            <td rowspan="2" align="center" class="w-xs col-bg"><small>V : <?php echo e($item['V-S6']); ?> <br>R :
                    <?php echo e($item['R-S6']); ?> <br>N : <?php echo e($item['N-S6']); ?></small></td>
            <td rowspan="2" align="center" class="w-xs col-bg"><?php echo e($item['Res-S6']); ?></td>


            <td rowspan="2" align="center" class="w-xs "><?php echo e($item['Moy_DEUST']); ?></td>
            <td rowspan="2" align="center" class="w-xs "><?php echo e($item['Moy_S5_S6']); ?></td>
    ...
    <?php else: ?>
        <tr>
            ...
            <?php $__currentLoopData = $data['modules']['S5']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <td align="center" class="w-xs"><?php echo e($item['Moy-S5']); ?></td>
            <td align="center" class="w-xs"><small>V : <?php echo e($item['V-S5']); ?> <br>R :
                    <?php echo e($item['R-S5']); ?> <br>N : <?php echo e($item['N-S5']); ?></small></td>
            <td align="center" class="w-xs"><?php echo e($item['Res-S5']); ?></td>
            ...
            <?php $__currentLoopData = $data['modules']['S6']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php endif; ?>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <td align="center" class="w-xs"><?php echo e($item['Moy-S6']); ?></td>
            <td align="center" class="w-xs"><small>V : <?php echo e($item['V-S6']); ?> <br>R :
                    <?php echo e($item['R-S6']); ?> <br>N : <?php echo e($item['N-S6']); ?></small></td>
            <td align="center" class="w-xs"><?php echo e($item['Res-S6']); ?></td>
            ...
            <td class="w-lg" colspan="3" align="center">DNC/DNR</td>
        </tr>
    <?php endif; ?>
...
<?php $__currentLoopData = $data['listeAJ']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php $counter = $counter + 1; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/deliberation/PDF/components/LST_liste.blade.php ENDPATH**/ ?>