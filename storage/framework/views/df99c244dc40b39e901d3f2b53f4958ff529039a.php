...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark py-3 py-lg-0 pl-3 pl-lg-5" style="background-color: #F4F5F8;">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <a href="<?php echo e(route('services')); ?>" class="nav-item nav-link active">Services</a>
    ...
    <!-- Search Start -->
<form method="GET" action="<?php echo e(route('cars')); ?>">
    <?php echo csrf_field(); ?>
        ...
        <div class="row mx-n2">
            ...
            <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                <select name="car_type" class="custom-select px-4 mb-3" style="height: 50px;" required>
                    ...
                    <option value="<?php echo e($voiture->marque); ?>"><?php echo e($voiture->marque); ?></option>
...
<?php /**PATH C:\Users\PC-ISLAM\Desktop\projet_driveNow\resources\views/front/services.blade.php ENDPATH**/ ?>