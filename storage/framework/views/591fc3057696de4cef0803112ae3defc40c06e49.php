...
<?php $__currentLoopData = $data['listeAJ']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
   <?php if(false): ?>
    ...
    <?php $counter = $counter + 1; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/fste-umi/public_html/fst/ens/website/resources/views/deliberation/PDF/components/DEUST_liste_demo.blade.php ENDPATH**/ ?>