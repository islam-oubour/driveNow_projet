...
<div class="container-fluid py-5 px-lg-5">
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-8">
            <div class="mb-4 bg-light" style="padding: 30px; box-shadow: 5px 10px 10px rgba(0, 0, 0, 0.1);">
                <div class="text-center mb-4">
                    <h2 class="text-dark">Log In</h2>
                    <p class="text-muted">Access your DriveNow client area</p>
                </div>
...
</html><?php /**PATH C:\Users\PC-ISLAM\Desktop\projet_driveNow\resources\views/front/login.blade.php ENDPATH**/ ?>