...
<aside class="sidebar">
    ...
    <nav>
        <ul>
            ...
            <li><a href="<?php echo e(route('acceuil')); ?>"><i class="bi bi-car-front"></i> Gestion Voitures</a></li>
            <li><a href="<?php echo e(route('User')); ?>"><i class="fas fa-users"></i> Utilisateurs</a></li>
            <li  class="active"><a href="<?php echo e(route('reservations')); ?>"><i class="bi bi-calendar-check"></i> Réservations</a></li>
            <li><a href="<?php echo e(route('payments')); ?>"><i class="bi bi-credit-card"></i> Paiements</a></li>
            <li><a href="<?php echo e(route('messages')); ?>"><i class="bi bi-envelope"></i> Messages</a></li>
            <li><a href="<?php echo e(route('logout')); ?>"><i class="fas fa-sign-out-alt"></i> Déconnexion</a></li>
        </ul>
    </nav>
</aside>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo e(\Carbon\Carbon::parse($res->date_debut)->format('d/m/Y')); ?> - <?php echo e(\Carbon\Carbon::parse($res->date_fin)->format('d/m/Y')); ?></td>
                <td><?php echo e($res->montant_total); ?> €</td>
                <td>
                    <span class="badge bg-<?php echo e($res->status == 'confirmé' ? 'success' : ($res->status == 'annulé' ? 'danger' : 'warning')); ?>">
                ...
                <td>
                    ...
                    <a href="<?php echo e(url('contrat.php?id=' . $res->id_location)); ?>" class="btn btn-sm btn-info" target="_blank">
...
</html><?php /**PATH C:\Users\PC-ISLAM\Desktop\website\resources\views/admin/reservations.blade.php ENDPATH**/ ?>