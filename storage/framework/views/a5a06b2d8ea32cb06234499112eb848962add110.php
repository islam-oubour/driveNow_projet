<head>
    ...
    <title>LISTE GLOBALE INSC <?php echo e($info['filiere']); ?> <?php echo e($info['semestre']); ?></title>
    <style>
        footer {
            z-index: 999;
            position: fixed;
...
<body>
    ...
    <div class="i-container" style="text-transform: uppercase;margin-top: 20px">
        <div>
            ...
            <h3 style="margin: 2px 0">FELIERE : <?php echo e($info['filiere']); ?> - SEMESTRE : <?php echo e($info['semestre']); ?></h3>
        </div>
        <table style="width: 100%">
            <tr>
                <td>
    ...
    <table id="res" style='text-transform: uppercase;font-size: 14px; margin-top: 30px'>
        <thead>
            <tr class="table-head">
                <th><b>CNE</b></th>
                <th><b>Nom</b></th>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/exportation/PDF/inscrits_globale_S5.blade.php ENDPATH**/ ?>