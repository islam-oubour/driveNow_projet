...
<div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    <li class="active"><a href="<?php echo e(route('index')); ?>"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
        ...
        <main class="main-content">
            ...
            <table>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $derniere_reservations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $res): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td><?php echo e($res->date_debut); ?> - <?php echo e($res->date_fin); ?></td>
                        <td><?php echo e($res->montant_total); ?> €</td>
                        <td><span class="badge bg-<?php echo e($res->status === 'confirmé' ? 'success' : 'warning'); ?>"><?php echo e($res->status); ?></span></td>
                    </tr>
        ...
        <div class="recent-activity mt-5">
            ...
            <table>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $reservations_retard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td><?php echo e($row->cinutilisateur); ?></td>
                        ...
                        <td><span class="badge bg-danger"><?php echo e($row->status); ?></span></td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr><td colspan="6">No late reservations.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>             
...
</html><?php /**PATH C:\Users\PC-ISLAM\Desktop\website\resources\views/Admin/index.blade.php ENDPATH**/ ?>