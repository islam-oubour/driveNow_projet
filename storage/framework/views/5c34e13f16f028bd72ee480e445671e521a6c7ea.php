...
<body>
    <div class="container">
        ...
        <div class="card mt-3 py-5">
			...
			<div class="alert text-center alert-danger mb-5 alert-dismissible fade show" role="alert">
     				

    			
  				Cette plateforme est  en phase de développement, il est fortement recommandé de consulter les listes de notes 
    	<a target="_blank" href="https://www.fste-umi.ac.ma/">ici</a>
                
                et de nous contacter en cas d'erreur.
                <br>
    			<div style="direction: rtl" >
    				يرجى الأخذ بعين الإعتبار ان هذه المنصة لا تزال في مرحلة التطوير ، ينصح و بشدة الإطلاع على لوائح النقط 
    	<a target='_blank' href='https://www.fste-umi.ac.ma/' >من هنا</a>
    و التواصل مع الكلية في حالة وجود خطأ.
    			</div>
			</div>
                        ...
                        <table class="table table-bordered table-notes">
                            ...
                            <td align="center"> <abbr
                                ...
                                <?php if($module->inscription == 1): ?>
                                    <br> <span class="badge bg-success">inscrit</span>
                                <?php endif; ?>
                            </td>
...
<?php /**PATH /home/fste-umi/public_html/services/notes/website/resources/views/home.blade.php ENDPATH**/ ?>