...
<head>
    ...
    <title>ETAT - ADMIS - <?php echo e($info['option']); ?> - <?php echo e($info['au']); ?> - <?php echo e($info['session']); ?></title>
    <style>
        body {
...
<body onload="window.print()">
    <div class="first-page">
        ...
        <div class="info text-left my-5" style="width: 100%; margin-top: 120px !important;">
            <h1 class="text-center">ETAT DES ADMIS <strong>LST</strong>
            </h1>
            ...
            <div class="text-center" style="text-transform: uppercase">
                OPTION : <strong><?php echo e($filiere); ?></strong> <br>    
    ...
    <div class="text-center">
        ...
        <?php else: ?>
        <p>Liste des étudiants classés par moyenne décroissant.</p>
        <?php endif; ?>
    </div><!-- End of .text-center -->
    <table id="liste" class="table table-bordered" style="width:100%">
        <thead style="background-color: #646464;">
            <tr>
                ...
                <th class="w-lg" align="center" colspan="8">S5</th>
                <th class="w-lg" align="center" colspan="6">S6</th>
                <th class="w-lg" align="center" colspan="4">Res</th>
            </tr>
            <tr>
        ...
        <tbody>
            <?php echo $__env->make('exportation/LST_liste_demo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </tbody>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/exportation/etat_admis_LST.blade.php ENDPATH**/ ?>