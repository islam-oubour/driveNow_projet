        ...
        <div class="page">
            ...
            <div class="mid">
                <div class="content" style="margin-top: 60px">
                    ...
                    a obtenu le <strong>Diplome de Licence en Sciences et Techniques (LST)</strong> :<br>
                    Filiére : <strong><?php echo e($item->filiere); ?></strong> (<strong><?php echo e($item->id_filiere); ?></strong>) <br>
                    Option : <strong><?php echo e($item->option); ?></strong> (<strong><?php echo e($item->id_option); ?></strong>) <br>
                    Année universitaire : <strong><?php echo e($item->au_jury_LST); ?></strong> <br>
                    ...
                    <div class="res" style="width: 100% ; text-align: center">
                        Moyenne : <strong><?php echo e(truncate_number($item->moyenne_LST)); ?></strong> <br>
                        <?php if($item->moyenne_LST >= 10 and $item->moyenne_LST < 12): ?>
                            Mention : <strong>Passable</strong>
                        <?php endif; ?>
                        <?php if($item->moyenne_LST >= 12 and $item->moyenne_LST < 14): ?>
                            Mention : <strong>Assez bien</strong>
                        <?php endif; ?>
                        <?php if($item->moyenne_LST >= 14 and $item->moyenne_LST < 16): ?>
                            Mention : <strong>Bien</strong>
                        <?php endif; ?>
                        <?php if($item->moyenne_LST >= 16): ?>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/deliberation/attestations/LST.blade.php ENDPATH**/ ?>