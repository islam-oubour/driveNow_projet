...
<aside class="sidebar">
    ...
    <nav>
        <ul>
            ...
            <li class="active"><a href="<?php echo e(route('User')); ?>"><i class="fas fa-users"></i> Utilisateurs</a></li>
            <li><a href="<?php echo e(route('reservations')); ?>"><i class="bi bi-calendar-check"></i> Réservations</a></li>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><a href="<?php echo e(route('admin.clients.show', $client->cinutilisateur)); ?>"><i class="bi bi-eye"></i></a></td>
                        </tr>
...
</html><?php /**PATH C:\Users\PC-ISLAM\Desktop\website\resources\views/admin/User.blade.php ENDPATH**/ ?>