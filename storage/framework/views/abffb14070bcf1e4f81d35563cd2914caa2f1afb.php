            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="" required class="course form-control">
                    </div>
                    <div class="form-group mb-3">
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchstudent() {
                $.ajax({
                    type: "GET",
                    url: "<?php echo e(route('students.fetch')); ?>",
                    dataType: "json",
            ...
            $(document).on('click', '.editbtn', function(e) {
                ...
                var link = "<?php echo e(route('students.edit',['id' => '%id%'])); ?>".replace('%id%',id);
            ...
            $(document).on('click', '.update_student', function(e) {
                ...
                $(this).text('Updating..');
                var id = $('#stud_id').val();
                var link = "<?php echo e(route('students.update',['id' => '%id%'])); ?>".replace('%id%',id);
                var data = {
                    'name': $('#name').val(),
                    'course': $('#course').val(),
                    'email': $('#email').val(),
            ...
            $(document).on('click', '.delete_student', function(e) {
                ...
                var link = "<?php echo e(route('students.destroy',['id' => '%id%'])); ?>".replace('%id%',id);
                console.log(link);
                ...
                $.ajax({
                    ...
                    dataType: "json",
                    success: function(response) {
                        console.log("<?php echo e(route('students.destroy',['id' => " + stud_id + "])); ?>");
                        if (response.status == 404) {
                            $('#success_message').addClass('alert alert-success');
                            $('#success_message').text(response.message);
...
<?php echo $__env->make('lt.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\STARTING_APP_V2\website\resources\views/student/index.blade.php ENDPATH**/ ?>