<head>
    ...
    <title>LISTE GLOBALE INSC <?php echo e($info['option']); ?> <?php echo e($info['semestre']); ?></title>
    <style>
        footer {
            z-index: 999;
            position: fixed;
...
<body>
    ...
    <div class="i-container" style="text-transform: uppercase;margin-top: 20px">
        <div>
            ...
            <h3 style="margin: 2px 0">OPTION : <?php echo e($info['option']); ?> - SEMESTRE : <?php echo e($info['semestre']); ?></h3>
        </div>
        <table style="width: 100%">
            <tr>
                <td>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/exportation/PDF/inscrits_globale_S6.blade.php ENDPATH**/ ?>