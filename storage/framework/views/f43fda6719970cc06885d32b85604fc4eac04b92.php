    ...
    <table id="liste" class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $data['listeAD']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="w-lg" rowspan="2"><strong><small><?php echo e($counter); ?> - <?php echo e($item['CNE']); ?></small>
                        </strong><br> <?php echo e($item['Nom']); ?> </td>
                    <?php $__currentLoopData = $data['modules']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td align="center" class="w-sm"><?php echo e($item[$module]); ?></td>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <td align="center" class="w-xs col-bg" rowspan="2"><?php echo e($item['Moy']); ?></td>
                    <td align="center" class="w-xs col-bg" rowspan="2"><small>V : <?php echo e($item['V']); ?> <br>R :
                            <?php echo e($item['R']); ?> <br>N : <?php echo e($item['N']); ?></small></td>
                    <td align="center" class="w-xs col-bg" rowspan="2"><?php echo e($item['Res']); ?></td>
                    <td align="center"></td>
                    <td align="center"></td>
                    <td align="center"></td>
                </tr>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\projet_vide_admin\website\resources\views/deliberation/PDF/deliberation_semestre.blade.php ENDPATH**/ ?>