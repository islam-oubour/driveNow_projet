          ...
          <div class="nav-item dropdown">
            <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
              ...
              <div class="d-none d-xl-block ps-2">
                <div><?php echo e($etudiant['nom_prenom_fr']); ?></div>
                <div class="mt-1 small text-muted"><?php echo e($etudiant['id_tronc']); ?></div>
              </div>
            </a>
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
              
              <a href="<?php echo e(route('login')); ?>" class="dropdown-item">Déconnexion</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="page-wrapper">
      ...
      <footer class="footer footer-transparent d-print-none">
        <div class="container-xl text-center">
            ...
            <?php echo e(env('APP_NAME')); ?> V1.0 © 2023 
        </div>
      </footer>
    </div>
  </div>
...
</html><?php /**PATH /home/fste-umi/public_html/services/affichage/website/resources/views/layouts/app.blade.php ENDPATH**/ ?>