        ...
        <div class="container <?php echo e(count($data) - 1 >= $count ? 'page-break' : ''); ?>">
            <table>
                <tr>
                    ...
                    <td>
                        <div class="info">
                            Option : <strong><?php echo e($key); ?></strong> <br>
            ...
            <div class="title" style="margin-top: 40px">
                <h3>Liste des etudiants admis <br> LST - <?php echo e($key); ?> </h3>    
            </div><!-- End of .title -->
            <table border="1" style="margin-top: 40px ">
                ...
                <tbody>
                    <?php $__currentLoopData = $option; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $etudiant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/deliberation/admis/admis_LST_Sig.blade.php ENDPATH**/ ?>