<head>
    ...
    <title>LISTE GLOBALE INSC <?php echo e($info['tronc']); ?></title>
    <style>
        @media  print {
            body * {
        ...
        @page  {
            ...
            @bottom-right {
                content: '<?php echo e($info['tronc']); ?>  -  ' counter(page) ' / ' counter(pages);
            }
        }
...
<body>
    ...
    <div class="i-container" style="text-transform: uppercase;margin-top: 20px">
        <div>
            ...
            <h3 style="margin: 2px 0">PARCOURS : <?php echo e($info['tronc']); ?></h3>
        </div>
        <table style="width: 100%">
            <tr>
                <td>
                ...
                <td align="right">
                    <div class="first">
                        <b>
                            ...
                            SESSION : <?php echo e(fst_session()); ?>
    ...
    <table id="res" style='text-transform: uppercase;font-size: 12px; margin-top: 30px'>
        <thead>
            <tr>
                <td colspan="27"  align="center"><?php echo e($info['tronc']); ?> - <?php echo e(fst_au()); ?> - <?php echo e(fst_session()); ?></td>
            </tr>
            <tr>
                <td rowspan="2"><b>N°</b></td>
                <td rowspan="2"><b>CNE</b></td>
                <td rowspan="2"><b>Nom et prénom</b></td>
                <td align="center" colspan="6"><b>S1</b></td>
                <td align="center" colspan="6"><b>S2</b></td>
                <td align="center" colspan="6"><b>S3</b></td>
                <td align="center" colspan="6"><b>S4</b></td>
            </tr>
            <tr class="table-head">
        ...
        <tbody>
            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $etudiant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <td style="text-transform: lowercase"><?php echo e($etudiant['Nom']); ?></td>
                    <?php $__currentLoopData = $modules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/exportation/PDF/inscrits_globale_DEUST.blade.php ENDPATH**/ ?>