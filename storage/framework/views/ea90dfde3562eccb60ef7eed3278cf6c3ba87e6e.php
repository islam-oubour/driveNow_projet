...
<body>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="container <?php echo e(count($data) - 1 >= $count ? 'page-break' : ''); ?>">
            <table style="width: 100%; padding: 0; margin-bottom: 5px">
                <tr>
                    ...
                    <table id="info">
                        ...
                        <?php if(isset($student['id_filiere'])): ?>
                            <tr>
                                ...
                                <td><strong>: </strong> <?php echo e($student['filiere']); ?> (<?php echo e($student['id_filiere']); ?>)</td>
                            </tr>
                        <?php endif; ?>
                        <?php if(isset($student['id_option'])): ?>
                            <tr>
                                <td> <strong>Option</strong> </td>
                                <td><strong>: </strong> <?php echo e($student['option']); ?> (<?php echo e($student['id_option']); ?>)</td>
                            </tr>
                        <?php endif; ?>
                    </table>
                </div><!-- End of .info -->
                <div class="content">
                    <?php if($student['externe'] != 1): ?>
                        <?php echo $__env->make('deliberation.releves.semestre', [
                            'data' => $student['S1'],
                            'semestre' => 'S1',
                            'moy' => $student['Moy-S1'],
                            'res' => $student['Res-S1'],
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/deliberation/releves/LST.blade.php ENDPATH**/ ?>