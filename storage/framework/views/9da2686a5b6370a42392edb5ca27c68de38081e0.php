    ...
    <div class="table-responsive">
        <table class="table table-bordered table-notes">
            <thead style="background-color: rgb(226, 226, 226)">
                <td align="center" rowspan="<?php echo e(count($data) + 3); ?>" ><?php echo e($semestre); ?></td>
            ...
            <tr style="border: none">
                ...
                <td style="background-color: rgb(226, 226, 226)" align='center' ><?php echo e(number_format((float)floor($moy * 100) / 100, 2, '.', '')); ?></td>
                    <?php if($moy< 10): ?>
                        <td style="background-color: rgb(226, 226, 226)" align='center' >-</td>
                    <?php endif; ?>
                    <?php if($moy >= 10 && $moy < 12): ?>
                    <td style="background-color: rgb(226, 226, 226)" align='center' >Passable</td>
                    <?php endif; ?>
                    <?php if($moy >= 12 && $moy < 14): ?>
                        <td style="background-color: rgb(226, 226, 226)" align='center' >Assez bien</td>
                    <?php endif; ?>
                    <?php if($moy >= 14 && $moy < 16): ?>
                    <td style="background-color: rgb(226, 226, 226)" align='center' >Bien</td>
                    <?php endif; ?>
                    <?php if($moy >= 16): ?>
                    <td style="background-color: rgb(226, 226, 226)" align='center' >Très Bien</td>
                    <?php endif; ?>
            </tr>
            <tr style="border: none">
                <?php if($res == 2): ?>

                    <td style="border: none;" align="right" colspan="3" > <span style="margin-right: 160px">* Module validé avec compensation </span> Résultat : </td>
                <?php else: ?>
                    <td style="border: none;" align="right" colspan="3" >Résultat : </td>
                <?php endif; ?>
                <?php if($res == 0): ?>
                    <td style="background-color: rgb(226, 226, 226)" class="table-success" align="center" colspan="2"  >Non validé</td>
                <?php else: ?>
                    <td style="background-color: rgb(226, 226, 226)" class="table-success" align="center" colspan="2"  >Validé</td>
                <?php endif; ?>
...
<?php endif; ?><?php /**PATH /var/www/html/docs/website/resources/views/PDF/layouts/semestre.blade.php ENDPATH**/ ?>