            ...
            <tbody>
                <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <?php if($item->note >= 10 || $item->compense == 1): ?>
                        ...
                        <?php if($item->note >= 10 || $item->compense == 1): ?>
                            <td class="table-success" align="center">
                                <?php echo e(fst_etat_module($item->note)); ?>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/etudiants/components/semestre.blade.php ENDPATH**/ ?>