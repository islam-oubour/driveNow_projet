        ...
        <div class="container py-5">
            ...
            <?php if($locations->isEmpty()): ?>
                <div class="no-reservations text-center">
                    ...
                    <a href="<?php echo e(route('cars')); ?>" class="btn btn-primary mt-3">Browse Cars</a>
                </div>
            <?php else: ?>
                <div class="row">
...
</html><?php /**PATH C:\Users\PC-ISLAM\Desktop\website\resources\views/front/carRental.blade.php ENDPATH**/ ?>