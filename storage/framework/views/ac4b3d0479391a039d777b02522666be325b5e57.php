        ...
        <tr>
            ...
            <td align="right">
                ...
                <div class="info text-left my-5" style="width: fit-content">
                    <h1>JURY DE <strong>LICENCE ● <?php echo e(fst_au()); ?></strong></h1>
                    <h2>Option : <strong><?php echo e($option['id']); ?></strong> ● Session : <strong><?php echo e(fst_session()); ?></strong></h2>
                </div><!-- End of .info -->
    ...
    <table class="table table-bordered my-3">
        ...
        <tbody>
            <tr>
                ...
                <td><strong><?php echo e(date('d/m/Y', strtotime($info['date']))); ?></strong></td>
                <td><strong><?php echo e($info['heure']); ?></strong></td>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\projet_vide_admin\website\resources\views/deliberation/PDF/deliberation_LST.blade.php ENDPATH**/ ?>