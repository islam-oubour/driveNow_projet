...
<body>
    ...
    <!-- Search Start -->
    <form method="GET" action="<?php echo e(route('search')); ?>" id="searchForm">
        <?php echo csrf_field(); ?>
            ...
            <div class="row mx-n2">
                ...
                <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                    <select name="Matricule" class="custom-select px-4 mb-3" style="height: 50px;" required>
                        ...
                        <option value="<?php echo e($voiture->Matricule); ?>"><?php echo e($voiture->marque); ?></option>
        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="<?php echo e(asset('img/cars3.png')); ?>" alt="">
                ...
                <?php $__currentLoopData = $voitures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $voiture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-4 col-md-6 mb-2">
                        <div class="rent-item mb-4">
                            ...
                            <?php else: ?>
                                <a class="btn px-3" href="<?php echo e(route('login.client', ['redirect' => route('book', ['car_id' => $voiture->Matricule])])); ?>" style="background-color: #2B2E4A; color: #ffffff;">
                                    $<?php echo e($voiture->prix); ?>/Day
                                </a>
                            <?php endif; ?>
                        </div>
            ...
            <div class="row mx-0">
                <div class="col-lg-6 px-0">
                    <div class="px-5 d-flex align-items-center justify-content-between" style="height: 350px; background-color: #F4F5F8; color: #2B2E4A;">
                        <img class="img-fluid flex-shrink-0 ml-n5 w-50 mr-4" src="<?php echo e(asset('img/banner-left.png')); ?>" alt="">
                ...
                <div class="col-lg-6 px-0">
                    <div class="px-5 d-flex align-items-center justify-content-between" style="height: 350px; background-color: #2B2E4A; color: #F4F5F8">
                        ...
                        <img class="img-fluid flex-shrink-0 mr-n5 w-50 ml-4" src="<?php echo e(asset('img/banner-right.png')); ?>" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    document.getElementById("searchForm").addEventListener("submit", function(e) {
        e.preventDefault();
        let isLoggedIn = <?php echo e(session('client_prenom') ? 'true' : 'false'); ?>;

        if (isLoggedIn) {
            this.submit();
        } else {
            window.location.href = "<?php echo e(route('login.client')); ?>";
        }
    });
   </script> 
    <!-- Back to Top -->
...
<?php /**PATH C:\Users\PC-ISLAM\Desktop\projet_driveNow\resources\views/front/home.blade.php ENDPATH**/ ?>