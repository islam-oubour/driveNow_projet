...
<head>
    ...
    <title>JURY - SEMESTRE - <?php echo e($info['semestre']); ?></title>
    <style>
        @media  print {
            a[href]:after {
...
<body onload="">
        ...
        <tr>
            ...
            <td align="right">
                ...
                <div class="info text-left my-5" style="width: fit-content">
                    <h2>JURY DE <strong>SEMESTRE ● <?php echo e($info['semestre']); ?> ● <?php echo e(fst_small_au(fst_au())); ?></strong></h2>
                    <?php if($info['semestre'] == 'S5' || $info['semestre'] == 'S6'): ?>
                        <?php if($info['semestre'] == 'S5'): ?>
                            <h3>FILIERE : <strong><?php echo e($info['filiere']); ?></strong> ● SESSION
                                :<strong><?php echo e(strtoupper(fst_session())); ?></strong>
                            <?php else: ?>
                                <h3>OPTION : <strong><?php echo e($info['filiere']); ?></strong> ● SESSION
                                    :<strong><?php echo e(strtoupper(fst_session())); ?></strong>
                        <?php endif; ?>
                    <?php else: ?>
                        <h3>PARCOURS : <strong><?php echo e($info['filiere']); ?></strong> ● SESSION :
                            <strong><?php echo e(strtoupper(fst_session())); ?></strong>
                    <?php endif; ?>
                    </h3>
    ...
    <table id="liste" class="table table-striped table-bordered" style="width:100%">
        <thead style="background-color: #646464;">
            <tr>
                <th class="w-lg">CNE</th>
                <th class="w-lg">Nom</th>
                <?php $__currentLoopData = $data['modules']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <th class="w-60"><?php echo e($module); ?></th>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <th class="w-70">MV</th>
                <th class="w-60">Moy</th>
                <th class="w-60">Rés</th>
            </tr>
        </thead>
        <tbody>
            <?php $counter = 1; ?>
            <?php $__currentLoopData = $data['listeAD']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td class="w-lg"><strong><small><?php echo e($counter); ?> - <?php echo e($item['CNE']); ?></small></td>
                    <td class="w-lg capitalize"><small><?php echo e(strtolower($item['Nom'])); ?></small></td>
                    <?php $__currentLoopData = $data['modules']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td align="center" class="w-60"><?php echo e($item['Moy']); ?></td>
                    <td align="center" class="w-60"><?php echo e($item['Res']); ?></td>
                </tr>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\projet_vide_admin\website\resources\views/deliberation/PDF/deliberation_semestre_demo.blade.php ENDPATH**/ ?>