...
<aside class="sidebar">
    ...
    <nav>
        <ul>
            ...
            <li><a href="<?php echo e(route('admin.reservations')); ?>"><i class="bi bi-calendar-check"></i> Réservations</a></li>
            <li class="active"><a href="<?php echo e(route('payments')); ?>"><i class="bi bi-credit-card"></i> Paiements</a></li>
...
<a href="<?php echo e(route('paiement.store')); ?>" class="add-car-btn" title="Ajouter une voiture">
  <i class="fa-solid fa-plus"></i>
</a>
</body>
</html><?php /**PATH C:\Users\PC-ISLAM\Desktop\website\resources\views/Admin/payments.blade.php ENDPATH**/ ?>