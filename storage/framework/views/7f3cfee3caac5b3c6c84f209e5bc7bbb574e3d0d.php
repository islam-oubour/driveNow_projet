...
<head>
    ...
    <title>JURY - DEUST - <?php echo e($tronc['id']); ?> - MOD</title>
    <style>
        td {
...
<body onload="window.print()">
    <div class="page-break first-page">
        ...
        <div class="info text-left my-5" style="width: 100%; margin-top: 120px !important;">
            <h1>JURY DE <strong>DEUST</strong>
            </h1>
            <h2>
                    PARCOURS : <strong><?php echo e($tronc['id']); ?></strong> <br> 
                    ...
                    <td class="b-none">
                        <table style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td><strong><?php echo e(count($data['listeAC'])); ?></strong></td>
                            </tr>
                            <tr>
                                <td>Total admis</td>
                                <td><strong><?php echo e(count($data['listeAD']) + count($data['listeAC'])); ?></strong></td>
                            </tr>
                            <tr>
                                <td>Ajourné</td>
                            ...
                            <tr>
                                <td>Total</td>
                                <td><strong><?php echo e(count($data['listeAD']) + count($data['listeAC']) + count($data['listeAJ'])); ?></strong></td>
                            </tr>
                        </table>
                    </td>
    ...
    <table id="liste" class="table table-bordered" style="width:100%">
        <thead style="background-color: #646464;">
            <tr>
                ...
                <th class="w-lg" colspan="9">S1</th>
                <th class="w-lg" colspan="9">S2</th>
                <th class="w-lg" colspan="9">S3</th>
                <th class="w-lg" colspan="9">S4</th>
                <th class="w-lg" colspan="3">Res</th>
                <th class="" colspan="3" rowspan="2">Signature</th>
            </tr>
            <tr>
                ...
                <?php $__currentLoopData = $data['modules']['S1']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td class="w-sm text-white"><?php echo e($module); ?></td>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <td class="w-xs text-white">Moy</td>
                <td class="w-xs text-white">MV</td>
                <td class="w-xs text-white">Rés</td>
        ...
        <tbody>
            <?php echo $__env->make('deliberation/PDF/components/DEUST_liste', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </tbody>
        <tfoot style="background-color: #646464;color: white">
            ...
            <tr>
                ...
                <?php $__currentLoopData = $data['modules']['S1']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <td class="w-sm"><?php echo e($module); ?></td>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <td class="w-xs">Moy</td>
                <td class="w-xs">MV</td>
                <td class="w-xs">Rés</td>
                ...
                <td class="w-xs" colspan="3">Signature</td>
...
<?php /**PATH /home/fste-umi/public_html/fst/ens/website/resources/views/deliberation/PDF/deliberation_DEUST.blade.php ENDPATH**/ ?>