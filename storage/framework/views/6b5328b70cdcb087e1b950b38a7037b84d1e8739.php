...
<head>
    ...
    <title>JURY - DEUST - <?php echo e($tronc['id']); ?> - AFF</title>
    <style>
        body {
...
<body onload="window.print()">
    ...
    <table id="liste" class="table table-bordered" style="width:100%">
        ...
        <tbody>
            <?php echo $__env->make('deliberation/PDF/components/DEUST_liste_demo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </tbody>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/deliberation/PDF/deliberation_DEUST_demo.blade.php ENDPATH**/ ?>