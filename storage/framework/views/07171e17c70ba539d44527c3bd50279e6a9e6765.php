...
<head>
    ...
    <title>JURY - LST - <?php echo e($option['id']); ?> - AFF</title>
    <style>
        td {
...
<body onload="window.print()">
    ...
    <table id="liste" class="table table-bordered" style="width:100%">
        ...
        <tbody>
            <?php echo $__env->make('deliberation/PDF/components/LST_liste_demo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </tbody>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/deliberation/PDF/deliberation_LST_demo.blade.php ENDPATH**/ ?>