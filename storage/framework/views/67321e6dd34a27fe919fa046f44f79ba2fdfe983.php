...
<body>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="container <?php echo e(count($data) - 1 >= $count ? 'page-break' : ''); ?>">
            ...
            <table border="1" id="table_jury" style="font-size: 16px ; margin-top: 50px">
                <thead>
                    <th scope="col">CNE</th>
                    <th scope="col">Nom</th>
...
<?php /**PATH /home/fste-umi/public_html/fst/ens/website/resources/views/deliberation/rachetage/bilan_semestre.blade.php ENDPATH**/ ?>