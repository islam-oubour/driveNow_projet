...
<head>
    ...
    <style>
        ...
        .loader {
            ...
            border-radius: 50%;
            padding: 1px;
            background: conic-gradient(#0000 10%, #007fa4) content-box;
            -webkit-mask:
...
<body class="bg-light">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            box.firstChild.style.marginBottom = "10px"
            box.firstChild.style.marginLeft = "5px"
            box.firstChild.style.marginRight = "5px"
            box.lastChild.style.marginTop = "10px"
            box.lastChild.style.marginLeft = "5px"
            box.lastChild.style.marginRight = "5px"
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/layout/app.blade.php ENDPATH**/ ?>