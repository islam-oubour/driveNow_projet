        ...
        <div class="col-xl-9 col-lg-8 col-md-12 col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row align-items-center mb-8">
                        ...
                        <div class="col-md-9">
                            <div class="d-flex align-items-center">
                                <div class="me-3">
                                    <img src="../assets/images/avatar/avatar-5.jpg" class="rounded-circle avatar avatar-lg"
                                        alt="">
                                </div>
                                <div>
                                    <button type="submit"
                    ...
                    form-label">Zip
                                    code <i data-feather="info" class="me-2 icon-xs"></i></label>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\projet_vide_admin\website\resources\views/auth/settings.blade.php ENDPATH**/ ?>