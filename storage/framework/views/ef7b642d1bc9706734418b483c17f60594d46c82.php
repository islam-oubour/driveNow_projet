                ...
                <div class="card-header">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo e(route('deliberation.rachetage.bilan' , ['jury' => 'S'])); ?>" class="dropdown-item" href="#">Semestre</a></li>
                                <li><a href="<?php echo e(route('deliberation.rachetage.bilan' , ['jury' => 'D'])); ?>" class="dropdown-item" href="#">DEUST</a></li>
                                <li><a href="<?php echo e(route('deliberation.rachetage.bilan' , ['jury' => 'L'])); ?>" class="dropdown-item" href="#">LST</a></li>
                            </ul>
                        </div>
                    </div><!-- End of .d-flex -->
                </div><!-- End of .card-header -->
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/fste-umi/public_html/fst/ens/website/resources/views/deliberation/rachetage/rachetage.blade.php ENDPATH**/ ?>