        ...
        <div class="container <?php echo e(count($members) - 1 >= $count ? 'page-break' : ''); ?>">
            <table>
                <tr>
                    ...
                    <td>
                        <div class="info">
                            Parcours : <strong><?php echo e($member['Tronc']); ?></strong> <br>
            ...
            <h2 class="title">convocation pour les <br> jurys de DEUST</h2>
            <h3 style="text-transform: uppercase">Pr. <?php echo e($member['Nom']); ?>

                <?php echo e($member['President'] == 1 ? '(Président de jury)' : ''); ?></h3> <br>
            <i>Le doyen de la FSTE a l'honneur de vous informer que vous êtes conviés pour les jurys de DEUST ci-dessous :</i>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\ens\website\resources\views/deliberation/convocations/conv_DEUST.blade.php ENDPATH**/ ?>