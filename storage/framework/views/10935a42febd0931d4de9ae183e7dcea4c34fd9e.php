    ...
    <table style="width: 100%; padding: 0; margin-bottom: 25px">
        <tr>
            <td style="margin: 10px 0" align="center">
                <h2>relevé de notes <br> - semestre <?php echo e($semestre); ?> -</h2>
            </td>
        </tr>
    </table>
    <main>
...
<?php /**PATH C:\Program Files (x86)\EasyPHP-Devserver-17\eds-www\docs\website\resources\views/PDF/rDiv.blade.php ENDPATH**/ ?>