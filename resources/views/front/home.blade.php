...
<body>
    ...
    <form method="GET" action="{{ route('search') }}" id="searchForm">
        ...
        <div class="container-fluid bg-white pt-3 px-lg-5">
            <div class="row mx-n2">
                ...
                <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                    <select name="Matricule" class="custom-select px-4 mb-3" style="height: 50px;" required>
                        <option selected>Select A Car</option>
                        @foreach($voitures as $voiture)
                        <option value="{{ $voiture->Matricule }}">{{ $voiture->marque }}</option>
                    @endforeach
                    </select>
                </div>
                <div class="col-xl-2 col-lg-4 col-md-6 px-2">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            @if(session('client_prenom'))
                                    <a href="{{ route('cars') }}" class="btn py-md-3 px-md-5 mt-2" style="background-color: #75564d; color: #ffffff;">Reserve Now</a>
                            @else
                                    <a href="{{ route('login.client') }}" class="btn py-md-3 px-md-5 mt-2" style="background-color: #75564d; color: #ffffff;">Reserve Now</a>
                            @endif                        </div>
                    </div>
                </div>
        ...
        <div class="container pt-5 pb-3">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 text-center">
                    <img class="w-75 mb-4" src="{{ asset('img/cars3.png') }}" alt="">
                ...
                @foreach($voitures as $voiture)
                    <div class="col-lg-4 col-md-6 mb-2">
                        <div class="rent-item mb-4">
                            <img class="img-fluid mb-4" src="{{asset($voiture->photo)}}" alt="">
                            <h4 class="text-uppercase mb-4"> {{ $voiture->marque }}</h4>
                            ...
                            @if (session('client_prenom'))
                                <a class="btn px-3" href="{{ route('book', ['car_id' => $voiture->Matricule]) }}" style="background-color: #2B2E4A; color: #ffffff;">
                                    ${{ $voiture->prix }}/Day
                                </a>
                            @else
                                <a class="btn px-3" href="{{ route('login.client', ['redirect' => route('book', ['car_id' => $voiture->Matricule])]) }}" style="background-color: #2B2E4A; color: #ffffff;">
                                    ${{ $voiture->prix }}/Day
                                </a>
                            @endif
                        </div>
            ...
            <div class="row mx-0">
                <div class="col-lg-6 px-0">
                    <div class="px-5 d-flex align-items-center justify-content-between" style="height: 350px; background-color: #F4F5F8; color: #2B2E4A;">
                        <img class="img-fluid flex-shrink-0 ml-n5 w-50 mr-4" src="{{ asset('img/banner-left.png') }}" alt="">
                        <div class="text-right">
                            ...
                            <a class="btn btn-secondary py-2 px-4" href="{{ route('cars') }}">Start Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 px-0">
                    <div class="px-5 d-flex align-items-center justify-content-between" style="height: 350px; background-color: #2B2E4A; color: #F4F5F8">
                        <div class="text-left">
                            ...
                            <a class="btn btn-light py-2 px-4" href="{{ route('cars') }}">Start Now</a>
                        </div>
    ...
    document.getElementById("searchForm").addEventListener("submit", function(e) {
        e.preventDefault();
        let isLoggedIn = {{ session('client_prenom') ? 'true' : 'false' }};
