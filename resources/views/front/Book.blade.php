        ...
        <div class="position-relative px-lg-5" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg navbar-dark py-3 py-lg-0 pl-3 pl-lg-5" style="background-color: #F4F5F8;">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    ...
                    @if(session('client_prenom'))
                        <a href="{{ route('carRental') }}" class="nav-item nav-link active">Car Rental</a>
                    @endif
            ...
            <div class="container pt-5 pb-3">
                <div class="reservation-container">
                    <h1 class="display-4 text-uppercase text-center mb-5" style="color: #2B2E4A;">
                        Réserver <span style="color: #75564d;">{{ $car->marque }} {{ $car->modele }}</span>
                    </h1>

                    <div class="row">
                        <div class="col-lg-6 mb-4">
                            <img src="{{ asset($car->photo) }}" class="img-fluid car-image" alt="{{ $car->marque }} {{ $car->modele }}">

                            <div class="mt-4 text-center">
                                <div class="price-display">Prix: {{ $car->prix }} DH / jour</div>
                                ...
                                <div class="detail-item">
                                    ...
                                    <span>Kilométrage: {{ $car->kilometrage }} km</span>
                                </div>
                            </div>
                        </div>
                         @if(!empty($pickup_date))
                                <form method="POST" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="date_debut" name="date_debut" required value="{{ $pickup_date }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="date_fin"> End Date</label>
                                        <input type="date" class="form-control" id="date_fin" name="date_fin" required value="{{ $drop_date }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="lieu_prise">Pickup Location</label>
                                        <input class="form-control" id="lieu_prise" name="lieu_prise" value="{{ $pickup_location }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label for="lieu_retour">Drop-off Location</label>
                                        <input class="form-control" id="lieu_retour" name="lieu_retour" value="{{ $drop_location }}" readonly>
                                    </div>
