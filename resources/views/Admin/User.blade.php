        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li class="active"><a href="{{ route('User') }}"><i class="fas fa-users"></i> Uers</a></li>
            ...
            <table>
                ...
                <tbody class="text-dark">
                    @forelse ($clients as $client)
                        <tr>
                            <td>{{ $client->cinutilisateur }}</td>
                            <td>{{ $client->nomutilisateur }} {{ $client->prenomutilisateur }}</td>
                            <td>{{ $client->loginutilisateur }}</td>
                            <td>{{ $client->telutilisateur }}</td>
                            <td>{{ $client->villeutilisateur }}</td>
                            <td>
                                <a href="{{ route('show', ['cin' => $client->cinutilisateur]) }}">
